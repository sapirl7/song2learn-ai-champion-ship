...
ICONIC_SONGS: Dict[str, List[IconicSong]] = {
    ...
    "pl": [
        IconicSong("12 Groszy", "Kazik", "Kazik's punk-rock anthem about materialism. Numbers vocabulary, social commentary, legendary Polish punk."),
        IconicSong("Sztos", "Kazik", "Energetic rock about excitement and perfection. Slang vocabulary, youth culture, catchy rhythm."),
        IconicSong("Ballada o Janku Wisniewskim", "Kazik", "Historical ballad about 1970 protests. Polish history vocabulary, emotional storytelling."),
        IconicSong("Nie płacz za mną", "Verba", "Hip-hop about farewells and moving on. Emotional vocabulary, clear pronunciation, relatable themes."),
        IconicSong("Nie wierzę już w miłość", "Verba", "Hip-hop ballad about lost faith in love. Relationship vocabulary, simple structure for beginners."),
        IconicSong("Serce", "Marek Grechuta", "Poetic song about the heart by Polish poetry-rock legend. Emotional vocabulary, beautiful Polish."),
        IconicSong("Serce Baila", "Margaret", "Modern pop dance hit 'Heart Dances'. Body and emotion vocabulary, contemporary Polish pop."),
        IconicSong("Małe serce", "Ralph Kaminski", "Indie-pop about a 'small heart'. Emotional vocabulary, modern Polish singer-songwriter style."),
        IconicSong("Po to jesteś na świecie", "Maanam", "Classic Polish rock about life's purpose. Philosophical vocabulary, Kora's iconic vocals."),
        IconicSong("MIłość Na Odwyku", "Kuki", "Modern Polish pop about love recovery. Relationship vocabulary, contemporary expressions."),
    ],
    "zh": [
